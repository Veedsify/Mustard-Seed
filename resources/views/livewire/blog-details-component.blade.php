...
<main>
    ...
    <section style="background-image: url({{asset($blog->image)}});background-size: cover;background-position: center;"
                    ...
                    <div class="single-blog">
                        <div class="blog-img">
                            <a href="javascript:void(0)">
                                <img src="{{asset('assets/images/gallery/blog-16.png')}}" class="img-fluid w-100" alt="img">
                            </a>
                            <div class="brush-bg">
                        ...
                        <div class="blog-info">
                            <div class="blog-info-title">
                                ...
                                <p class="subtitle">As you may know, there are millions of children living in
                                    poverty,
                                    without access to basic necessities like food,clean water, Food healthcare. Many
                                    of
                                    these children are also denied the opportunity.,</p>
                                <div class="divider"></div>
                                <p class="subtitle">As you may know, there are millions of children living in
                                    poverty,
                                    without access to basic necessities like food, clan water, and Big healthcare.
                                    Many
                                    of these children are also denied the opportunity to receive an education,
                                    perpetu
                                    ating the cycle of poverty and limiting their potential for a better future</p>
                                <p class="subtitle">We understand that there are many organizations seeking support,
                                    and
                                    ...
                                    <div class="quote">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="76" height="54"
                                            ...
                                            <path
                                                ...
                                                stroke="#090E0D" stroke-width="4"></path>
                                        </svg>
                                    </div>
                                    <h4 class="title">Donating to charity is a great way to make a positive impact
                                        on
                                        the world and help those in need. There are many different type of charities
                                        and
                                        causes tosuport, ranging from local.</h4>
                                </div>
                                <div class="d-flex gap-20">
                                    <div class="blog-multi-img">
                                        <img src="{{asset('assets/images/gallery/blog-multi-1.png')}}" alt="image">
                                    </div>
                                    <div class="blog-multi-img">
                                        <img src="{{asset('assets/images/gallery/blog-multi-2.png')}}" alt="image">
                                    </div>
                                </div>
                                <div class="donation-content">
                                    <h4 class="title">donation</h4>
                                    <p class="pera">As you may know, there are millions of children living in
                                        poverty,
                                        without access to basic necessities like food, clea water, and Big
                                        healthcare.
                                        Many of these children are also denied the opportunity to receive an
                                        education,
                                    ...
                                    <ul class="bullet-list">
                                        <li class="list">This is a personal decision that requires careful
                                            consideration.</li>
                                        <li class="list">help save lives, while others may donate their body to
                                            medical
                                            research or education.</li>
                                        <li class="list">it's important to discuss your wishes with your family</li>
                                    </ul>
                                    <p class="subtitle">There are millions of children living in poverty, without
                                        access
                                        to basic necessities like food, clean water,and Big he althcare. Many of
                                        these
                                    ...
                                    <div class="single-blog h-calc">
                                        <div class="blog-img">
                                            <a href="blog-details.html">
                                                <img src="{{asset('assets/images/gallery/blog-verti.png')}}" class="img-fluid w-100"
                                                    alt="img">
                                            </a>
                                        </div>
                                        <div class="blog-info">
                        ...
                        <div class="related-post-section">
                            ...
                            <div class="related-box">
                                <div class="single-post">
                                    <div class="post-img">
                                        <a href="blog-details.html"><img src="{{asset('assets/images/gallery/post-1.png')}}"
                                                alt="img"></a>
                                    </div>
                                    <div class="post-info">
                                        <div class="date-time">
                                ...
                                <div class="single-post">
                                    <div class="post-img">
                                        <a href="blog-details.html"><img src="{{asset('assets/images/gallery/post-2.png')}}"
                                                alt="img"></a>
                                    </div>
                                    <div class="post-info">
                                        <div class="date-time">
                                ...
                                <div class="single-post">
                                    <div class="post-img">
                                        <a href="blog-details.html"><img src="{{asset('assets/images/gallery/post-3.png')}}"
                                                alt="img"></a>
                                    </div>
                                    <div class="post-info">
                                        <div class="date-time">
                                ...
                                <div class="single-post">
                                    <div class="post-img">
                                        <a href="blog-details.html"><img src="{{asset('assets/images/gallery/post-4.png')}}"
                                                alt="img"></a>
                                    </div>
                                    <div class="post-info">
                                        <div class="date-time">
